...
Node *insert(Node *node, ll left, ll right, ll idx, ll val) // Update for a single version
{
...
Node *query(Node *Current, ll left, ll right, ll leftQuery, ll rightQuery)
{
...
Node *insert(Node *Current, ll idx, ll val)
{
